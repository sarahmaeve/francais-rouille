# Vocabulaire — La Vie en Appartement

## 01 — Email : Panne de Chauffage

| Français | English |
|---|---|
| une panne | a breakdown, a fault |
...
| Français | English |
|---|---|
| un chauffagiste | a heating technician |
| la chaudière | the boiler |
| la vanne trois voies | the three-way valve |
| purger (un radiateur) | to bleed (a radiator) |
| le circuit (de chauffage) | the (heating) circuit/system |
| un tuyau | a pipe |
...
| Français | English |
|---|---|
| un courrier recommandé | a registered letter |
| un accusé de réception | an acknowledgment of receipt |
| le numéro de suivi | the tracking number |
| la douane | customs |
...
| faire une démarche | to take an administrative step |
| le 3631 | La Poste customer service number |

## 04 — Avis du Syndic : Chiens en Laisse

| Français | English |
|---|---|
| le syndic (de copropriété) | building management association |
...
| Français | English |
|---|---|
| la fibre optique | fiber optic |
| le syndic de copropriété | building management association |
| la colonne montante | the riser (vertical pipe/cable shaft) |
| les parties communes | common areas |
| le droit à la fibre | the right to fiber (French law) |
| le conseil syndical | the building council |
| un bail | a lease |
| un opérateur | a provider (telecom) |
| les murs porteurs | load-bearing walls |
| les chemins de câble | cable runs/cable trays |
| le palier | the landing (staircase) |
| une copropriété | a co-ownership (condominium) |
| une loge | a concierge's office |
| une consigne | an instruction, a directive |

## Expressions Générales — La Vie en Appartement

| Français | English |
|---|---|
| un locataire / une locataire | a tenant |
| un propriétaire | an owner, a landlord |
| une agence immobilière | a property management agency |
| un immeuble | an apartment building |
| la résidence | the residence, the complex |
| les charges | service charges, building fees |
| un état des lieux | an inventory of fixtures |
| le loyer | the rent |
