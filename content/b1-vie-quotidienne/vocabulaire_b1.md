# Vocabulaire B1 — Mots et Expressions Clés
...
| changer (de ligne) | to change / transfer (lines) |
...
| valable | valid |
| un plan | a map |
| les couloirs | the corridors / hallways |
| un panneau | a sign |
...
| le four | the oven |
| sortir du four | to come out of the oven |
| tout chaud | piping hot |
| pour emporter | to take away / to go |
...
| une rue commerçante | a shopping street |
| un magasin | a shop / store |
| rater | to miss |
| passer devant | to pass in front of |
| une église | a church |
| déboucher sur | to come out onto / to open onto |
| une place | a square (town square) |
| un endroit | a place / spot |
| les conseils | advice / tips |
| environ | approximately / about |
| juste derrière | just behind |
| un peu cher | a bit expensive |
| bienvenue | welcome |
...
| un deux pièces | a one-bedroom apartment (lit. two rooms) |
| le loyer | the rent |
...
| le séjour / le salon | the living room |
| la chambre | the bedroom |
| la cuisine équipée | the fitted kitchen |
| la salle de bains | the bathroom |
| le parquet en chêne | oak parquet flooring |
| donner sur | to overlook / to face |
| la cour intérieure | the inner courtyard |
| un réfrigérateur | a refrigerator |
| des plaques de cuisson | stovetop / hob |
| un lave-vaisselle | a dishwasher |
| un lavabo | a sink (bathroom) |
| une douche | a shower |
| le double vitrage | double glazing |
| une cave | a cellar / storage room |
| un digicode | a keypad entry code |
| un interphone | an intercom |
| recherché | sought-after / desirable |
| à proximité | nearby |
...
| meublé | furnished |
| vide | unfurnished (lit. empty) |
| loué | rented |
| par contre | on the other hand / however |
| entièrement | entirely / fully |
| au niveau de | regarding / in terms of |
| le bruit | the noise |
| animé | lively / bustling |
| rassurant | reassuring |
| des espaces verts | green spaces / parks |
...
| un truc | a thing (informal) |
| sympa | nice / friendly (informal for "sympathique") |
| carrément | totally / absolutely (informal) |
| génial | awesome / brilliant |
| un fromager | a cheese seller |
| un resto | a restaurant (informal) |
| pas mal | quite a few / not bad |
...
| grave | totally / seriously (slang intensifier) |
| hyper | very / super (informal intensifier) |
| nickel | perfect / spotless (informal) |
| chill | chill / relaxed (borrowed from English) |
| à coup sûr | for sure / definitely |
